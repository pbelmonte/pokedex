...
const Pagination = ({ prevPokemon, nextPokemon }: Props) => (
  <div className="flex">
    <Link
    ...
    >
      <div className="flex justify-center">
        ...
        <span className="mr-2 font-bold text-lg">{formatId(prevPokemon.id)}</span>
        <span className="text-dark-gray font-bold text-lg"><ReplaceGender name={prevPokemon.name} /></span>
      </div>
    </Link>
    <Link
    ...
    >
      <div className="flex justify-center">
        <span className="mr-2 text-dark-gray font-bold text-lg"><ReplaceGender name={nextPokemon.name} /></span>
