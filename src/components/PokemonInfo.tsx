...
const PokemonInfo = ({ height, weight, gender, category, abilities }: Props) => (
  <div className="grid grid-cols-2 p-6 rounded-lg bg-light-blue">
    <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex">
          {(gender === 'both' || gender === 'male') && (<p className="text-xl mr-4"><IoMdMale /></p>)}
          {(gender === 'both' || gender === 'female') && (<p className="text-xl"><IoMdFemale /></p>)}
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        {
          abilities.map((item) => <p className="text-xl">{fromSnakeToText(item)}</p>)
        }
      </div>
    </div>
  </div>
